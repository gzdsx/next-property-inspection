...
import {
    ChevronLeft, Edit2, Check, Plus, Trash2, Clock, Play, Video, Search, Filter, Undo
} from "lucide-react";
...
export default function RoomDetailPage() {
    ...
    const [roomRecords, setRoomRecords] = useState<any[]>([]);
    ...
    const fetchRoomData = async () => {
        try {
            ...
            const filtered = (records || []).filter((r: any) => (r.room_name || "").toLowerCase() === roomName.toLowerCase());
    ...
    const handleCellChange = (recordId: string, field: string, value: any) => {
            ...
            <div style={{justifyContent: "center", alignItems: "center"}}>
                <div className="glass-panel"
                    ...
                    <Link href={`/report/${id}`} className="sheet-select"
                          style={{display: "inline-block", marginTop: "20px", textDecoration: "none"}}>Back to
                        report</Link>
                </div>
            </div>
        );
        ...
        <>
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <div className="glass-panel"
                         style={{overflow: "hidden", background: "black", borderRadius: "16px"}}>
                        <video
                            ref={videoRef}
                ...
                <div style={{display: "flex", flexDirection: "column", gap: "24px"}}>
                    ...
                    <div className="glass-panel" style={{overflow: "hidden"}}>
                        <div style={{
                            ...
                            <h3 style={{margin: 0, fontSize: "0.95rem", fontWeight: "bold"}}>Elements (Building &
                                Hard Features)</h3>
                            {isEditing && (
                                <button
                                    type="button"
                                            ...
                                            {isEditing ? (
                                                <div style={{display: "flex", alignItems: "center", gap: "6px"}}>
                                                        <span style={{
                                                            fontSize: "0.75rem",
                                                            fontFamily: "monospace"
                                                        }}>{formatTime(item.elapsedSeconds || 0)}</span>
                                                    <button
                                                        type="button"
                              ...
                              {item.condition}
                                        ...
                                        <td className="sheet-td">
                                            {isEditing ? (
                                                ...
                                                <span
                                                    style={{color: "var(--text-muted)"}}>{item.description || "N/A"}</span>
                                            )}
                                        </td>
                                    </tr>
                                ))}
                    ...
                    <div className="glass-panel" style={{overflow: "hidden"}}>
                        <div style={{
                            ...
                            <h3 style={{margin: 0, fontSize: "0.95rem", fontWeight: "bold"}}>Inventory & Safety
                                (Furnishings / Appliances)</h3>
                            {isEditing && (
                                <button
                                    type="button"
