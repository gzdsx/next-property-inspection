                            ...
                            functionDeclarations: [{
                                ...
                                parameters: {
                                    ...
                                    properties: {
                                        room_name: {
                                            type: Type.STRING,
                                            description: "The current area or room in ENGLISH, strictly normalized to: EXTERIOR FRONT, EXTERIOR REAR, HALLWAY, STAIRS, LANDING, LIVING ROOM, SITTING ROOM, KITCHEN, KITCHEN/LIVING COMBO, UTILITY ROOM, GUEST WC, STORAGE CLOSET, HOT PRESS, STUDY, OFFICE, BEDROOM 1, BEDROOM 2, ENSUITE BATHROOM 1, ENSUITE BATHROOM 2, MAIN BATHROOM. Map and translate inspector's verbal words."
                                        },
                                        item_name: {
                                            type: Type.STRING,
                                            description: "The standard item being inspected, in ENGLISH (e.g., Flooring, Walls, Window, Door, Electrics, Lighting, Smoke Detector)."
                                        },
                                        description: {
                                            type: Type.STRING,
                                            description: "The material or specific type of the item, in ENGLISH (e.g., Laminate, Painted plaster, UPVC Double glazed, Solid wood, White ceramic). Translate from Chinese if needed."
                                        },
                                        condition: {
                                            type: Type.STRING,
                                        ...
                                        severity: {
                                            type: Type.STRING,
                                            description: "Severity of the issue if any, in English."
                                        }
                                    },
