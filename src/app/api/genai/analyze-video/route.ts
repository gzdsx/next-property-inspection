      ...
      config: {
        ...
        responseSchema: {
          ...
          items: {
            type: Type.OBJECT,
            properties: {
              room_name: { type: Type.STRING, description: "The room name in ENGLISH, strictly mapped to unified conventions: EXTERIOR FRONT, EXTERIOR REAR, HALLWAY, STAIRS, LANDING, LIVING ROOM, SITTING ROOM, KITCHEN, KITCHEN/LIVING COMBO, UTILITY ROOM, GUEST WC, STORAGE CLOSET, HOT PRESS, STUDY, OFFICE, BEDROOM 1, BEDROOM 2, ENSUITE BATHROOM 1, ENSUITE BATHROOM 2, MAIN BATHROOM." },
              item_name: { type: Type.STRING, description: "The item being checked in ENGLISH (e.g. Window, Flooring)" },
              ...
              severity: { type: Type.STRING, description: "Issue severity (Low/Medium/High or empty string)" },
              elapsedSeconds: { type: Type.INTEGER, description: "The elapsed time in seconds from the start of the video when this item or defect is shown or discussed (e.g., 26 for 26 seconds)." }
            },
